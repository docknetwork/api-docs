...
The new process of validating and authenticating credentials is instantaneous and leaves no room for error and tempering.

## Participants in the Process

### Issuer
The issuer in the parody above is the university. The educational institution providing the certificate. They also have the power to revoke the credential if necessary.
